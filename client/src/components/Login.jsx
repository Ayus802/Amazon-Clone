...
function Login() {
  return (
    <div className=' h-screen w-full flex items-center justify-center'>
        <div className='  flex flex-col border border-gray-400 p-10'>
            <h1 className='text-center text-2xl'>Amazoon</h1>
            ...
            <span className='mt-12 mb-2 text-center'>New to Amazoon</span>
